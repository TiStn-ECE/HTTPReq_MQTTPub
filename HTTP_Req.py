...
def publishToBroker(jsonData):
    ...
    data["m2m:rqp"]["pc"]["m2m:cin"]["con"] = json.dumps(jsonData)
    print("Payload\n\n")
...
def myRequest():
    URI = "https://platform.antares.id:8443/~/antares-cse/antares-id/app-name/device-name/la"
    head = {
